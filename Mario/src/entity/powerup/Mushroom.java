...
public class Mushroom extends Entity {
    ...
    public Mushroom(int x, int y, int width, int height, boolean solid, Id id, Handler handler, int type){
        super(x, y, width, height, solid, id, handler);                                         //eklendi
        ...
        switch (dir) {
            case 0: setVelX(-3); // case:'sý düzeltildi 
            case 1: setVelX(3);
        }
    }
    ...
    public void render(Graphics g){
    	...
    	case 0:
    		 ...
    		 break;
    	case 1:
    		 g.drawImage(Main.lifeMushroom.getBufferedImage(), x, y, width, height, null);
    		 break;
